...
public class DifferentCountDownUI : MonoBehaviour
{
    public static DifferentCountDownUI Instance { get; private set; }
    ...
    private IEnumerator ShowGoRoutine(float duration)
    {
        ...
        if (DifferentState.Instance != null)
        {
            DifferentState.Instance.StartGameAfterGo();
        }
    }
}
